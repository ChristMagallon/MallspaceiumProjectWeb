<%@ Page EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never" Async="true"  Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="AdvertisementPaymentApproval.aspx.cs" Inherits="mallspacium_web.MasterForm.AdvertisementPaymentApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form">
        <asp:GridView ID="advertisementGridView" class="table table-bordered table-condensed table-responsive table-hover bg-white" runat="server" AutoGenerateColumns="False" DataKeyNames="userEmail" OnSelectedIndexChanged="advertisementGridView_SelectedIndexChanged" OnRowDataBound="advertisementGridView_RowDataBound">
            <Columns>
            ...
            <asp:BoundField HeaderText="Advertisement Product ID" DataField="adsProductID"></asp:BoundField>
