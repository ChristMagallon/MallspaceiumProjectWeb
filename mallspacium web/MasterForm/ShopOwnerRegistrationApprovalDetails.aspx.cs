...
namespace mallspacium_web.MasterForm
{
    public partial class ShopOwnerRegistrationApprovalDetails : System.Web.UI.Page
    {
        ...
        public async void approvedActivity()
        {
            ...
            {
                { "id", activityID },
                { "activity", (string)Application.Get("usernameget") + " approved shop owner " + emailLabel.Text + " registration."},
                { "email", emailLabel.Text },
                { "userRole", userRoleLabel.Text },
                { "date", date }
            };
        ...
        public async void disapprovedActivity()
        {
            ...
            {
                { "id", activityID },
                { "activity", (string)Application.Get("usernameget") + " disapproved shop owner " + emailLabel.Text + " registration."},
                { "email", emailLabel.Text },
                { "userRole", userRoleLabel.Text },
                { "date", date }
            };
