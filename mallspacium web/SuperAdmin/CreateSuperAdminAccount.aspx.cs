...
{
    public partial class CreateSuperAdminAccount : System.Web.UI.Page
    {
        ...
        public async void validateInput()
        {
            ...
            CollectionReference usersRef2 = database.Collection("SuperAdminAccount");
            Query query2 = usersRef2.WhereEqualTo("superAdminUsername", usernameTextbox.Text);
            ...
            Query query = usersRef.WhereEqualTo("superAdminEmail", emailTextbox.Text);
        ...
        public async void addAccount()
        {
            ...
            string adminID = "SUP" + randomIDNumber.ToString();

            //Get current date time and the expected expiration date
            DateTime currentDate = DateTime.Now;
            string date = currentDate.ToString("yyyy-MM-dd HH:mm:ss");

            DocumentReference doc = database.Collection("SuperAdminAccount").Document(emailTextbox.Text);
            ...
            Dictionary<string, object> data1 = new Dictionary<string, object>()
            {
              ...
              { "superAdminDateCreated", date},
              { "superAdminPassword", passwordTextbox.Text},
              { "superAdminConfirmPassword", confirmPasswordTextbox.Text}
            };
            await doc.SetAsync(data1);

            // Display a message
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertScript", "alert('Successfully added a new super admin account!');", true);

            // Redirect to another page after a delay
            string url = "SuperAdminAccount.aspx";
