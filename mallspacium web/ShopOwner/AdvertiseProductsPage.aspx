        ...
        <div class="col-md-10 offset-1">
            <div class="card p-3">
                ...
                <div class="table-responsive-xxl">
                    <asp:GridView ID="advertisementGridView" CssClass="table table-bordered table-striped table-hover bg-white" runat="server" AutoGenerateColumns="False" DataKeyNames="adsProdId" OnRowDataBound="advertisementGridView_RowDataBound" OnRowDeleting="advertisementGridView_RowDeleting" ShowHeaderWhenEmpty="True" EmptyDataText="No advertisement posted.">
                        <EmptyDataTemplate>
                            <div style="text-align:center;">
                                No advertisement posted.
                            </div>
                          </EmptyDataTemplate>
                        <Columns>
