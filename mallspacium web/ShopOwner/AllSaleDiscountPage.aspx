...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="table-responsive">
    <asp:GridView ID="allSaleDiscountGridView" class="table table-bordered table-hover bg-white" runat="server" AutoGenerateColumns="False" DataKeyNames="saleDiscShopName, saleDiscDesc" OnRowDataBound="allSaleDiscountGridView_RowDataBound" OnSelectedIndexChanged="allSaleDiscountGridView_SelectedIndexChanged">
        <Columns>
