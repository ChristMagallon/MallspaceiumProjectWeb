   ...
   <div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p><i class="fas fa-map-marker-alt"></i> <asp:Label ID="addressLabel" runat="server" Text=""></asp:Label></p>
        </div>
    </div>
</div>
<div class="container mt-5">
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
            <asp:TextBox ID="productSearchTextBox" runat="server" CssClass="form-control" type="search" placeholder="Search Product Name or Tag" aria-label="Search" AutoPostBack="True"></asp:TextBox>
        </div>
    </div>

<div class="table-responsive">
    <asp:GridView ID="productGridView" CssClass="table table-bordered table-condensed table-hover bg-white" runat="server" AutoGenerateColumns="False" OnRowDataBound="productGridView_RowDataBound">
        <Columns>
            ...
            <asp:BoundField HeaderText="Price" DataField="prodPrice" SortExpression="prodPrice" />
    ...
    <div class="text-center mt-3">
        <asp:Label ID="productErrorMessageLabel" runat="server" Visible="false"></asp:Label>
    </div>
</div>
