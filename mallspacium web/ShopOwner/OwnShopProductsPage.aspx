...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form">
        ...
        <div class="form">
            <asp:GridView ID="OwnShopProductGridView" class="table table-bordered table-condensed table-responsive table-hover bg-white" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" OnRowEditing="OwnShopProductGridView_RowEditing" OnRowDeleting="OwnShopProductGridView_RowDeleting" >
                <Columns>
                    <asp:BoundField HeaderText="Name" DataField="prodName" SortExpression="prodName" ></asp:BoundField>
                    <asp:BoundField HeaderText="Image" DataField="prodImage" SortExpression="prodImage"></asp:BoundField>
