            ...
            <div class="col-md-8 col-lg-6">
                <div class="card border-0 shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label12" runat="server" Text="Tag: "></asp:Label> 
                            <asp:Label ID="tagLabel" runat="server" Text=""></asp:Label> <br /> <br />
                        </div>

                        <div class="form-group">
                            <asp:Label ID="Label14" runat="server" Text="Availability: "></asp:Label> 
                            <asp:Label ID="availabilityLabel" runat="server" Text=""></asp:Label> <br />  <br />  
                        </div>

                        <div class="form-group">
                            <asp:Label ID="Label15" runat="server" Text="Shop Name: "></asp:Label> 
                    ...
                    <hr>
                    <center>
                        <asp:Button ID="addWishlistButton" runat="server" Text="ADD TO WISHLIST" CssClass="btn btn-primary" OnClick="addWishlistButton_Click"/>
                    </center>
                </div>
            </div>
        </div>
