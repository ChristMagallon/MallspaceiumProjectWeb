...
<!-- start here -->
    <div class="form">
            ...
            <asp:GridView ID="myWishlistGridView" class="table table-bordered table-condensed table-responsive table-hover bg-white" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="true" OnRowDataBound="myWishlistGridView_RowDataBound" OnRowDeleting=" myWishlistGridView_RowRemoving" >
                <Columns>
