        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asp:GridView ID="saleDiscountGridView" CssClass="table table-bordered table-condensed table-hover bg-white" runat="server" AutoGenerateColumns="False" DataKeyNames="saleDiscShopName, saleDiscDesc" OnRowDataBound="saleDiscountGridView_RowDataBound" OnSelectedIndexChanged="saleDiscountGridView_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No sales & discount posted.">
                            <EmptyDataTemplate>
                                <div style="text-align:center;">
                                  No sales & discount posted.
                                </div>
                            </EmptyDataTemplate>
                            <Columns>
