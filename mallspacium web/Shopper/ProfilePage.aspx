<%@ Page EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never" Async="true" Title=""  Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="ProfilePage.aspx.cs" Inherits="mallspacium_web.MasterForm3.WebForm7" %>
            ...
            <div class="col-md-10 offset-1">
                <div class="card p-3">
                    ...
                    <div class="card-header">
                            <h4 class="text-center">Recently Visited Shops</h4>
                    </div>
                    ...
                    <div class="table-responsive-xxl">
                        <asp:GridView ID="visitedShopsGridView" CssClass="table table-bordered table-striped table-hover bg-white" runat="server" AutoGenerateColumns="False" DataKeyNames="shopName" OnRowDataBound="visitedShopsGridView_RowDataBound" OnSelectedIndexChanged="visitedShopsGridView_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No recently visited shop record.">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Date Visited" DataField="dateVisited" SortExpression="dateVisited"></asp:BoundField>
                            </Columns>
