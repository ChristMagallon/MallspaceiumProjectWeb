        ...
        <div class="container" style="width: 40%; height: 40%;">
            <div class="row">
                ...
                <div class="mb-3 mt-3">
                      ...
                      <asp:RequiredFieldValidator ID="FirstNameRequiredFieldValidator" runat="server" ErrorMessage="Field is required *" ControlToValidate="FirstNameTextBox" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="mb-3 mt-3">
                      ...
                      <asp:RequiredFieldValidator ID="LastNameRequiredFieldValidator" runat="server" ErrorMessage="Field is required *" ControlToValidate="LastNameTextBox" ForeColor="Red" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="mb-3 mt-3">
                      ...
                      <asp:RequiredFieldValidator ID="ShopNameRequiredFieldValidator" runat="server" ErrorMessage="Field is required *" ControlToValidate="ShopNameTextBox" ForeColor="Red" ValidationGroup="Validate" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <div class="mb-3">
                      ...
                      <asp:RequiredFieldValidator ID="EmailRequiredFieldValidator" runat="server" ControlToValidate="EmailTextBox" Display="Dynamic" ErrorMessage="Field is required *" ForeColor="Red" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                ...
                <div class="mb-3">
                      ...
                      <asp:RequiredFieldValidator ID="AddressRequiredFieldValidator" runat="server" ControlToValidate="AddressTextBox" ErrorMessage="Field is required *" ForeColor="Red" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="mb-3 mt-3">
                      ...
                      <asp:RequiredFieldValidator ID="UsernameRequiredFieldValidator" runat="server" ErrorMessage="Field is required *" ControlToValidate="UsernameTextBox" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="mb-3">
                      ...
                      <asp:RequiredFieldValidator ID="ConfirmPassRequiredFieldValidator" runat="server" ControlToValidate="PasswordTextBox" Display="Dynamic" ErrorMessage="Field is required *" ForeColor="Red" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                      <asp:CompareValidator ID="ConfirmPassCompareValidator" runat="server" ControlToCompare="PasswordTextBox" ControlToValidate="ConfirmPasswordTextBox" Display="Dynamic" ErrorMessage="Password does not match!" ForeColor="Red" ValidationGroup="Validate"></asp:CompareValidator>
                </div>
