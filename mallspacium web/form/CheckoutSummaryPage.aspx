...
&nbsp;<asp:Label ID="Label5" runat="server" Text="Mallspaceium Merchant"></asp:Label>
            ...
            <br />
            <asp:Label ID="Label7" runat="server" Text="Transaction no:"></asp:Label>
&nbsp;<asp:Label ID="TransactionNoLabel" runat="server"></asp:Label>
            <br />
            <br />
            Total to pay:
            <asp:Label ID="Label8" runat="server" Text="PHP"></asp:Label>
